...
def fun(company):
  ...
  print("/////////////////////////////////////////////////")
  print(income_statement)
  x['income_statement'] = str(income_statement.to_html())
  ...
  print("/////////////////////////////////////////////////")
  print(balance_sheet)
  x['balance_sheet'] = str(balance_sheet.to_html())
  ...
  print(CF_forec)
  x['CF_forec'] = str(CF_forec.to_html())
  print('')
  ...
  lastString = company + ' Forecasted price per stock is ' + str(target_price_per_share)
  forecastString = 'The forecast is based on the following assumptions: '
  Revenuegrowth =  '1. Revenue growth: ' + str(revenue_g)
  WACC = '2. Cost of Capital [ WACC ]: ' + str(wacc_company)
  Perpetuity = '3. Perpetuity Growth: ' + str(LTGrowth)

  x['last'] = lastString
  x['forecastString'] = forecastString
  x['Revenuegrowth'] = Revenuegrowth
  x['WACC'] = WACC
  x['Perpetuity'] = Perpetuity
